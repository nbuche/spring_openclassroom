...
public class ProjetResource extends AbstractResource {
    ...
    @POST
    @Path("{id}/addVersion/{numVersion}")
    public Version addVersion(@PathParam("id") Integer pId, @PathParam("numVersion") String pNumVersion) throws NotFoundException, FunctionalException {
    	...
    	Projet vProjet = vProjetManager.getProjet(pId);
    	vVersion.setProjet(vProjet);
    	vVersion.setNumero(pNumVersion);
    	    	
    	vProjetManager.insertVersion(vVersion);
